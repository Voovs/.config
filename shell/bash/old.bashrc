...
#alias safe='cd ~/.safe_house/safe; ll | grep ^l | cut -d '"'"' '"'"' -f 15'
alias oldsafe='cd /Users/vselin/documents/safe_house/safe'
...
# Move to routing directory and print all the symbolic links' names
safe
